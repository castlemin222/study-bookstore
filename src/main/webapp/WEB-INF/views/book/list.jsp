...
<div class="container my-3">
    <div class="row mb-2">
		<div class="col">
			<div class="d-flex justify-content-between align-items-center border-bottom border-dark border-2">
				<p>도서 목록을 확인하세요</p>
				<form id="form-paging" class="d-flex justify-content-end w-75 mb-3" method="get" action="list">
					...
					<div class="input-group ms-3">
						<select class="form-select" id="option-field" name="opt">
					...
					<div class="input-group mx-3">
						<input type="text" class="form-control" id="keyword-field" name="keyword" value="${param.keyword }">
					</div>
